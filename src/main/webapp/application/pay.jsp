...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            onload = function(){
                $("ul[class='op_express_delivery_hot'] li").trigger("click");
                $("ul[class='op_express_delivery_hot'] li:eq(0)").trigger("click");
                $("ul[class='pay-list'] li").trigger("click");
                $("ul[class='pay-list'] li:eq(0)").trigger("click");
            }
...
<div class="concent">
    ...
    <div class="paycont">
        <div class="address">
            <h3>确认收货地址 </h3>
            <div class="control">
                <div class="tc-btn createAddr theme-login am-btn am-btn-danger"><a href="application/addAddress.jsp" style="color: white;">使用新地址</a></div>
            </div>
            <div class="clear"></div>
            <ul class="addressChoose">
                ...
                <c:forEach items="${list}" var="addr">
                    <c:choose>
                        <c:when test="${addr.isdefault eq '是'}">
                        ...
                        <div class="bundle  bundle-last">
                            ...
                            <div class="bundle-main">
                                <ul class="item-content clearfix">
                                        ...
                                        <li class="td td-item">
                                            <div class="item-pic">
                                               ...
                                               <%-- <a href="#" class="J_MakePoint">
                                                    <img src="images/${domain.goods_pic}" style="width: 80px; height: 80px" class="itempic J_ItemImg"></a>--%>
                                            </div>
                                            <div class="item-info">
                                                <div class="item-basic-info">
                                                    <img src="images/${domain.picture}" alt="" height="80px">
                                                 <%--   <a href="#" class="item-title J_MakePoint" data-point="tbcart.8.11">${domain.goods_description}</a>--%>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="td td-price">
                                            <div class="item-price price-promo-promo">
                                                <div class="price-content">
                                                    ...
                                                    <div class="price-line">
                                                        <em class="J_Price price-now" id="priceNow" tabindex="0">${domain.price}</em>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                    ...
                                    <li class="td td-amount">
                                        <div class="amount-wrapper ">
                                            <div class="item-amount ">
                                                ...
                                                <div class="sl">
                                                    <input class="text_box" id="count" type="text" value="${domain.count}" style="width: 30px; text-align: center;"/>
                                    ...
                                    <li class="td td-sum">
                                        <div class="td-inner">
                                            <em tabindex="0" class="J_ItemSum number" id="singlePrice"><fmt:formatNumber type="number" value="${domain.count*domain.price}" maxFractionDigits="1"/></em>
                                        </div>
                                    </li>
            ...
            <div class="order-go clearfix">
                <div class="pay-confirm clearfix">
                    <div class="box">
                        <div tabindex="0" id="holyshit267" class="realPay"><em class="t">实付款：</em>
                            <span class="price g_price ">
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee"><fmt:formatNumber type="number" value="${cart.price+cart.list.size()*10}" maxFractionDigits="1"/></em>
											</span>
                        </div>
                    ...
                    <div id="holyshit269" class="submitOrder">
                        ...
                        <form action="Shoping/submit" method="post" id="form">
                            <input type="hidden" name="username" value="" id="buy_user"/>
                            <input type="hidden" name="userphone" value="" id="userphone"/>
                            <input type="hidden" name="useradress" value="" id="address"/>
