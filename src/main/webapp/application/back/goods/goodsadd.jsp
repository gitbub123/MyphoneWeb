...
<script type="text/javascript">
	$(function(){
		...
		$("#goods_parentid").change(function(){
			...
			$.get("GoodsServlet?action=big",obj,function(data){
			var	arr=eval(data);
			var text="";
...
<body>
    ...
    <form action="GoodsServlet?action=add" method="post" enctype="multipart/form-data">
    	<ul class="forminfo">
	    ...
	    <li><label>所属小类</label>
	     ...
	     <li><label>商品图片</label><input name="goods_pic" type="file" id="upload" /></li>
