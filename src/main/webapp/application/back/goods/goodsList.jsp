...
<body>
    ...
    <div class="tools">
    	...
    	<ul class="toolbar">
        <li class="click"><a href="GoodsServlet?action=addInit"><img src="images/t01.png" align="middle" />添加</a></li>
    ...
    <table class="tablelist" >
    	<thead>
    	<tr>
        <th><input name="" type="checkbox" value="" checked="checked" id="allSel"/></th>
        <th>商品编号</th>
        <th>商品名称</th>
        <th>商品描述</th>
        <th>商品图片</th>
        ...
        <c:forEach items="${page.list}" var="goods">
	        ...
	        <td>
	        <a href="GoodsServlet?action=EditInIt&id=${goods.id}" class="tablelink">编辑</a>     
			<a href="GoodsServlet?action=del&id=${goods.id}" class="tablelink"> 删除</a>
			</td>
	        </tr>
	   </c:forEach>    
        </tbody>
