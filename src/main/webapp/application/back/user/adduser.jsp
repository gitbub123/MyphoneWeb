...
<script type="text/javascript">
	$(function(){
		var sex=${st.sex};
		$("#sex").val(sex);//只要赋值就会选中
		
		var isAdmin=${st.isAdmin};
		$("isAdmin").val(isAdmin);
	})
</script>
</head>
...
<body>
    ...
    <form action="sysUser/add" method="post">
		...
		<li><label>年龄</label><input name="age" type="text" class="dfinput" value="${st.phone}" /></li>
		...
		<li><label>地址</label><input name="adress" type="text" class="dfinput" value="${st.phone}" /></li>
		<li><label>是否管理员</label><select name="admin" class="dfinput" id="isAdmin">
