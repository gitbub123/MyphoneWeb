...
<section class="Contain">
    <div class="Inside">
        ...
        <section class="MainContent">
            <div class="MainContentBox Product1">
                <div class="Content">
                    <div class="Product1List">
                        <ul>
                            <li>
                                <a href="application/product1Infor.jsp"><img src="uploadfiles/image/img27.jpg" width="215" height="192" /></a>
                                <span>经典黑Iphone6塑胶</span>
                                <p>5.5''大屏 / 2GB内存 / 3100mAh电池</p>
                                <a href="application/product1Infor.jsp" class="more">查看参数</a>
                            </li>
                            <li>
...
<script type="text/javascript">
    jQuery(".Product1List ul li").each(function(i) {
        if((i+1)%3==0){
