...
<section class="Contain">
    <div class="Inside">
        ...
        <section class="MainContent">
            <div class="MainContentBox Product2">
                <div class="Content">
                    <div class="Product2List">
                        <ul>
                            <li>

                                <a href="Shoping/dd/1"><img src="images/p1.jpg" width="215" height="192" /></a>
                                <span>iPhone8 Plus/7Plus/6s Plus钢化膜</span>
                                <p>非全屏覆盖保护膜</p>
                                <a href="Shoping/dd/1" class="more">查看参数</a>
                            </li>
                            <li>
                                <a href="Shoping/dd/2"><img src="images/mo2.jpg" width="215" height="192" /></a>
                                <span>素雅白Iphone6塑胶</span>
                                <p>5.5''大屏 / 2GB内存 / 3100mAh电池</p>
                                <a href="Shoping/dd/2" class="more">查看参数</a>
                            </li>
                            <li>
                                <a href="Shoping/dd/3"><img src="images/mo3.jpg" width="215" height="192" /></a>
                                <span>土豪金Iphone6塑胶</span>
                                <p>5.5''大屏 / 2GB内存 / 3100mAh电池</p>
                                <a href="Shoping/dd/3" class="more">查看参数</a>
                            </li>
                            <div class="clear"></div>
                        </ul>
                        <div class="Pages">
                            <span class='p_total'>3条记录</span>
                            <span class='p_cur'>1</span><span class='p_count'>/1</span>
                            <span class='p_page'>
...
<script type="text/javascript">
    jQuery(".Product2List ul li").each(function(i) {
        if((i+1)%3==0){
