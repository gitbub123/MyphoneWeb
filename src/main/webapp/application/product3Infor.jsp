    ...
    <div class="Inside">
        ...
        <section class="MainContent">
            <div class="MainContentBox">
                ...
                <div class="Content">
                    <div class="Product3Infor">
                        <div class="Product3Img">
                        ...
                        <div class="Product3Brief">
                            <div class="BriefTitle">
                                <span>保护/缓冲系列</span>
                                <p>100元</p>
                            </div>
                            <div class="Product3Model">
                                <span>适用型号</span>
                                <p>苹果手机 iPhone5</p>
                            </div>
                            <div class="BriefCont">
                                <span>产品简介</span>
                                <p>国际知名的手机配件制造商品牌之一。国际知名的手机配件制造商品牌之一。国际知名的手机配件制造商品牌之一。总部设在香港,12年入驻中国。aopulan(奥普兰)数年来专注于手机配件、移动电源手机外壳、手机保护套领域的香港,12年入驻中国。aopulan(奥普兰)数年来专注于手机配件、移动电源手机外壳、手机保护套领域的...</p>
                            </div>
                        </div>
                        <div class="clear"></div>
                        <div class="Product3Content">
                            <div class="TabList">
                                <ul>
...
<script type="text/javascript">
    jQuery(".Product3Img").slide({mainCell:".BigImg ul",titCell:".SmallImgList ul li",effect:"left",prevCell:".prev",nextCell:".next"});
    jQuery(".Product3Content").slide({mainCell:".ContentList ul",titCell:".TabList ul li",effect:"left",trigger:"click"});
    jQuery(".SmallImgList").width(jQuery(".BigImg ul li").size()*78);
    jQuery(".Product3Img a").each(function(){
